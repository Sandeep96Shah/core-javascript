const obj = {
  ...
  normalMethod: function () {
    ...
    function innerNormal1() {
      ...
      // undefined because in innernormal1 context this is undefined
      const check = () => {
        console.log("Nestedt    234567io", this.name);
      };
...
const obj1 = {
  ...
  sayLater() {
    setTimeout(function () {
      console.log(this.name); // undefined because Regular function in setTimeout has its own this (global).
    }, 1000);
  },
};
...
const obj2 = {
  ...
  sayLater() {
    setTimeout(() => {
      console.log(this.name); // Lucy because it take the this reference from its context.
    }, 1000);
  },
};
